...
Structure: Customer transaction and demographic data

Key Fields: Customer ID, Age, Gender, Category, Purchase Amount, Review Rating, Subscription Status, Shipping Type

Goal: Analyze customer behavior, identify purchasing trends, and develop interactive business dashboards.
...
Compared purchasing patterns across different age groups.
Assessed customer subscription trends.
...
Young Adult customers contributed the highest share of revenue and purchases.
